...
#define STRING_CONFIG_H_AUTHOR "(Arne Wohlert, CR-10S)" // Who made the changes.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, 0, -1.25 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE // no - 15mm Extra space on the right end
#define Y_MAX_POS Y_BED_SIZE // no - 4mm Extra space behind the bed
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN P1_28 // Creality CR10-S stock sensor  //X_MAX_PIN aka. P1_28
